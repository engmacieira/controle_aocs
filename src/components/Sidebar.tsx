  ...
  return (
    <aside className="w-64 bg-white border-r border-slate-200/80 hidden sm:flex flex-col sticky top-0 h-screen shrink-0">
      <div className="p-6 border-b border-slate-100 flex items-center gap-3">
        ...
        <div>
          <h1 className="text-sm font-bold text-slate-900 tracking-tight leading-tight">Secretaria<br/>Ação Social</h1>
        </div>
      </div>
      ...
      {user && (
        <div className="p-4 border-t border-slate-100 flex flex-col gap-1.5">
          ...
          >
            ...
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={`w-4.5 h-4.5 transition-colors ${activeTab === 'administracao' ? 'text-indigo-600' : 'text-slate-400 group-hover:text-slate-600'}`}>
